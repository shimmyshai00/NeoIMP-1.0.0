#ifndef SDF_MODELLAYER_DOMAINOBJECTS_EDITING_COMPONENT_HPP
#define SDF_MODELLAYER_DOMAINOBJECTS_EDITING_COMPONENT_HPP
 ...
 *
 * FILE:    Component.hpp
 * PURPOSE: Defines the DI component for the editing subsystem.
 */
