#ifndef SDF_UILAYER_GUI_QT_CONTROLLER_SAVEASDIALOGCONTROLLER_HPP
#define SDF_UILAYER_GUI_QT_CONTROLLER_SAVEASDIALOGCONTROLLER_HPP

/*
 * NeoIMP version 1.0.0 (STUB) - toward an easier-to-maintain GIMP alternative.
 * (C) 2020 Shimrra Shai. Distributed under both GPLv3 and MPL licenses.
 *
 * FILE:    SaveAsDialogController.hpp
 * PURPOSE: Defines the SaveAsDialogController class.
 */
...
namespace SDF::UILayer {
  ...
  namespace Gui::Qt::Controller {
    // Class:      SaveAsDialogController
    // Purpose:    Handles events from the save-as dialog.
    // Parameters: None.
    class SaveAsDialogController : public Interfaces::IEventHandler<Events::GuiEvent> {
    public:
      SaveAsDialogController(AbstractModel::IDocumentStorageService *documentStorageService,
