#ifndef SDF_UILAYER_GUI_EVENTS_TOOLBOXEVENT_HPP
#define SDF_UILAYER_GUI_EVENTS_TOOLBOXEVENT_HPP

/*
 * NeoIMP version 1.0.0 (STUB) - toward an easier-to-maintain GIMP alternative.
 * (C) 2020 Shimrra Shai. Distributed under both GPLv3 and MPL licenses.
 *
 * FILE:    ToolboxEvent.hpp
 * PURPOSE: Defines the ToolboxEvent event hierarchy.
 */
