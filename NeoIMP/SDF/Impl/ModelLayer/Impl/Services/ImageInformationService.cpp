...
namespace SDF::Impl::ModelLayer::Impl::Services {
  ...
  std::string
  ImageInformationService::getImageName(AppModelLayer::AbstractModel::Handle handle) {
    try {
  ...
  int
  ImageInformationService::getImageWidth(AppModelLayer::AbstractModel::Handle handle) {
    try {
  ...
  int
  ImageInformationService::getImageHeight(AppModelLayer::AbstractModel::Handle handle) {
    try {
