#ifndef SDF_IMPL_APPMODELLAYER_ABSTRACTMODEL_DATA_DOCUMENTSPEC_HPP
#define SDF_IMPL_APPMODELLAYER_ABSTRACTMODEL_DATA_DOCUMENTSPEC_HPP
...
namespace SDF::Impl::AppModelLayer::AbstractModel::Data {
  struct DocumentSpec {
