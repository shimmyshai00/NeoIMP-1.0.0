#ifndef SDF_IMPL_UILAYER_IMPL_CONTROLLER_APPLICATION_DOCUMENTCONTROLLER_HPP
#define SDF_IMPL_UILAYER_IMPL_CONTROLLER_APPLICATION_DOCUMENTCONTROLLER_HPP
...
namespace SDF::Impl::UILayer::Impl::Controller::Application {
  class DocumentController : public Framework::MVCBaseController {
  public:
    DocumentController(Framework::IMVCView *view);
    ~DocumentController();
