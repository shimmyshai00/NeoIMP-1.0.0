#ifndef SDF_IMPL_UILAYER_IMPL_METRICS_LENGTH_UNITS_UNITS_HPP
#define SDF_IMPL_UILAYER_IMPL_METRICS_LENGTH_UNITS_UNITS_HPP
...
namespace SDF::Impl::UILayer::Impl::Metrics::Length::Units {
  // Unit enumeration.
  enum {
