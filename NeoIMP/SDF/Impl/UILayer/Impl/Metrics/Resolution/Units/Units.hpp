#ifndef SDF_IMPL_UILAYER_IMPL_METRICS_RESOLUTION_UNITS_UNITS_HPP
#define SDF_IMPL_UILAYER_IMPL_METRICS_RESOLUTION_UNITS_UNITS_HPP
...
namespace SDF::Impl::UILayer::Impl::Metrics::Resolution::Units {
  // Unit enumeration.
  enum {
    RESOLUTION_UNIT_PPI,
