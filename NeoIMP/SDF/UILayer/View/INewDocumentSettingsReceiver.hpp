#ifndef SDF_UILAYER_VIEW_INEWDOCUMENTSETTINGSRECEIVER_HPP
#define SDF_UILAYER_VIEW_INEWDOCUMENTSETTINGSRECEIVER_HPP

/*
 * NeoIMP version 1.0.0 (STUB) - toward an easier-to-maintain GIMP alternative.
 * (C) 2020 Shimrra Shai. Distributed under both GPLv3 and MPL licenses.
 *
 * FILE:    INewDocumentSettingsReceiver.hpp
 * PURPOSE: The receiver interface for new-document settings.
 */
...
namespace SDF::UILayer::View {
  ...
  public:
    virtual ~INewDocumentSettingsReceiver() = default;
