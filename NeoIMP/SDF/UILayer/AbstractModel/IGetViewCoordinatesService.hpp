#ifndef SDF_UILAYER_ABSTRACTMODEL_IGETVIEWCOORDINATESSERVICE_HPP
#define SDF_UILAYER_ABSTRACTMODEL_IGETVIEWCOORDINATESSERVICE_HPP
...
namespace SDF::UILayer::AbstractModel {
  ...
  public:
    ...
    // Purpose:    Get the X-coordinate of the viewing point of an image document. Note that the
    //             meaning here of a "viewing point" is up to the specific kind of UI layer to
