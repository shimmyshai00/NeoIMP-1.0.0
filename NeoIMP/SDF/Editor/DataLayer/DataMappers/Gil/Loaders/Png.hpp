#ifndef SDF_EDITOR_DATALAYER_DATAMAPPERS_GIL_LOADERS_PNG_HPP
#define SDF_EDITOR_DATALAYER_DATAMAPPERS_GIL_LOADERS_PNG_HPP
 ...
 *
 * FILE:    Png.hpp
 * PURPOSE: Defines a visitor-friendly algorithm-like object to load Boost.GIL entities from PNG
 *          format.
 */
