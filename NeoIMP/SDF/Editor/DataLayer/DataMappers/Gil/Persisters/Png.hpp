#ifndef SDF_EDITOR_DATALAYER_DATAMAPPERS_GIL_PERSISTERS_PNG_HPP
#define SDF_EDITOR_DATALAYER_DATAMAPPERS_GIL_PERSISTERS_PNG_HPP
...
namespace SDF::Editor::DataLayer::DataMappers::Gil::Persisters {
  ...
  struct Png {
    ...
    void
    operator()(const ModelLayer::DomainObjects::Engine::Image<GilSpecT> &image);
  };
}
