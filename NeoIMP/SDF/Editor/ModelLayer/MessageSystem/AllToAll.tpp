#ifndef SDF_EDITOR_MODELLAYER_MESSAGESYSTEM_ALLTOALL_TPP
#define SDF_EDITOR_MODELLAYER_MESSAGESYSTEM_ALLTOALL_TPP
...
namespace SDF::Editor::ModelLayer::MessageSystem::Impl {
  template<class MessageT>
  class Connection : public Common::IConnection {
  public:
...
namespace SDF::Editor::ModelLayer::MessageSystem {
  ...
  {
    return Common::PIConnection(new Impl::Connection<MessageT>(&m_subscribers, &m_filters,
      subscriber, filter));
  }
}
