#ifndef SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_GIL_COLORSPACES_HPP
#define SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_GIL_COLORSPACES_HPP
...
namespace SDF::Editor::ModelLayer::DomainObjects::Engine::Gil::ColorSpaces {
  // Types.
