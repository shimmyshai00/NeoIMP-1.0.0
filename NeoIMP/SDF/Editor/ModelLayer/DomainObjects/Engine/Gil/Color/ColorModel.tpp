#ifndef SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_GIL_COLOR_COLORMODEL_TPP
#define SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_GIL_COLOR_COLORMODEL_TPP
...
namespace SDF::Editor::ModelLayer::DomainObjects::Engine::Gil::Color {
  ...
  std::size_t
  ColorModel<GilPixelT>::getNumChannels() const {
    return boost::gil::num_channels<GilPixelT>::value;
  }
