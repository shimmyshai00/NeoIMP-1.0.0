#ifndef SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_COLORMODELS_BASE_HPP
#define SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_COLORMODELS_BASE_HPP
...
namespace SDF::Editor::ModelLayer::DomainObjects::Engine::ColorModels {
  ...
  class Base : public IColorModel<PixelDataT> {
  private:
