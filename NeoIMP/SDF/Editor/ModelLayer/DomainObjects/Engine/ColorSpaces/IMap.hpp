#ifndef SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_COLORSPACES_IMAP_HPP
#define SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_COLORSPACES_IMAP_HPP
 ...
 *
 * FILE:    IMap.hpp
 * PURPOSE: Defines the IMap class.
 */
...
namespace SDF::Editor::ModelLayer::DomainObjects::Engine::ColorSpaces {
  ...
  public:
    ...
    virtual void
    fundamentalToVals(const float *fs, float *vals) const = 0;
  };
}
