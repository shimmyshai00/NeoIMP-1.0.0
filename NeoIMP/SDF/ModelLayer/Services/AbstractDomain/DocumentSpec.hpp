#ifndef SDF_MODELLAYER_SERVICES_ABSTRACTDOMAIN_DOCUMENTSPEC_HPP
#define SDF_MODELLAYER_SERVICES_ABSTRACTDOMAIN_DOCUMENTSPEC_HPP
...
namespace SDF::ModelLayer::Services::AbstractDomain {
  struct DocumentSpec {
    ...
    // nb: duplicate these structures to remove UILayer references here to follow "one level down" principle better?
