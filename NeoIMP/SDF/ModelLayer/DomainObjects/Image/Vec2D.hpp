#ifndef SDF_MODELLAYER_DOMAINOBJECTS_IMAGE_VEC2D_HPP
#define SDF_MODELLAYER_DOMAINOBJECTS_IMAGE_VEC2D_HPP
 ...
 *
 * FILE:    Vec2D.hpp
 * PURPOSE: Definition of a type representing a 2D vector. Vectors are not the same as coordinates, in this setup.
 */
