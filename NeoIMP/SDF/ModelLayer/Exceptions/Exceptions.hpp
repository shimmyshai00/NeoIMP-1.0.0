...
namespace SDF::ModelLayer::Exceptions {
  struct DocumentNotFoundException : public SDF::Exception {
    DocumentNotFoundException(Common::Handle handle)
  ...
  struct RenderingNotFoundException : public SDF::Exception {
    RenderingNotFoundException(Common::Handle handle)
  ...
  struct ObjectNotFoundException : public SDF::Exception {
    ObjectNotFoundException(Common::Handle id)
      : Exception(true, "Could not find an object with id '%d' in the repository.", id)
      {}
  };
  ...
  struct InvalidLengthUnitException : public SDF::Exception {
    InvalidLengthUnitException(UILayer::AbstractModel::Defs::ELengthUnit unit)
  ...
  struct InvalidResolutionUnitException : public SDF::Exception {
    InvalidResolutionUnitException(UILayer::AbstractModel::Defs::EResolutionUnit unit)
