#ifndef SDF_MODELLAYER_METRICS_LENGTHCONVERTIBLE_HPP
#define SDF_MODELLAYER_METRICS_LENGTHCONVERTIBLE_HPP
...
namespace SDF::ModelLayer::Metrics {
  ...
  // Parameters: None.
  class LengthConvertible :
    public UILayer::AbstractModel::Defs::IUnitConvertible<UILayer::AbstractModel::Defs::ELengthUnit>
  {
  public:
