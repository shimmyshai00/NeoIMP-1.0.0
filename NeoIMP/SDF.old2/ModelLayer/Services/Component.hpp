 ...
 *
 * FILE:    Component.hpp
 * PURPOSE: Defines the DI component for the model layer services.
 */
...
namespace SDF::ModelLayer::Services {
  typedef fruit::Component<UILayer::AbstractModel::Services::ICreateDocumentService,
                           UILayer::AbstractModel::Services::IMeasurementConversionService
                          >
  Component;
