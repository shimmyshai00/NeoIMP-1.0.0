...
namespace SDF::UILayer::QtApplication::Controller {
  ControllerFactory::ControllerFactory(AbstractModel::Services::IMeasurementConversionService *
  ...
  ControllerFactory::createNewDocumentDialogController() {
    return std::make_unique<NewDocumentDialogController>(m_measurementConversionService);
  }
}
