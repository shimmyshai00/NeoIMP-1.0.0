#ifndef SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_GIL_COLORMODELS_GILRGBA_TPP
#define SDF_EDITOR_MODELLAYER_DOMAINOBJECTS_ENGINE_GIL_COLORMODELS_GILRGBA_TPP
...
namespace SDF::Editor::ModelLayer::DomainObjects::Engine::Gil::ColorModels {
  ...
  >
  inline void
  GilRgba<GilPixelT, BitsR, BitsG, BitsB, BitsA>::convertPixelTo(GilPixelT px, float *values) const
  {
