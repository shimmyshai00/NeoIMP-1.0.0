#ifndef SDF_DATALAYER_PERSISTENCE_COMPONENT_HPP
#define SDF_DATALAYER_PERSISTENCE_COMPONENT_HPP
 ...
 *
 * FILE:    Component.hpp
 * PURPOSE: Defines the DI component for the persistence subsystem.
 */
...
namespace SDF::DataLayer::Persistence {
  typedef fruit::Component<Interfaces::IFactory<Repositories::AbstractPersistence::IDataMapper<
