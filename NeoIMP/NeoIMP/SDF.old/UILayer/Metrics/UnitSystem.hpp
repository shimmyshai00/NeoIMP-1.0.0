#ifndef SDF_UILAYER_METRICS_UNITSYSTEM_HPP
#define SDF_UILAYER_METRICS_UNITSYSTEM_HPP
...
BOOST_UNITS_DEFINE_CONVERSION_FACTOR(SDF::UILayer::Metrics::point_base_unit,
                                     SDF::UILayer::Metrics::millimeter_base_unit,
                                     float,
                                     25.4f / 72.0f
                                    );
