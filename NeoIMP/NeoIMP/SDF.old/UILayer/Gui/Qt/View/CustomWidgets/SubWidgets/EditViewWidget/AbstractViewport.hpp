...
namespace SDF::UILayer::Gui::Qt::View::CustomWidgets::SubWidgets::EditViewWidget {
  ...
  public:
    ...
    // Function:   translate
    // Purpose:    Gets the whole translation vector for this viewport widget.
    // Parameters: None.
    ...
    // Purpose:    Sets the full translation used by this viewport widget.
    // Parameters: translate - The new translation vector.
    // Returns:    None.
    void
    setTranslate(QPointF translate);
  ...
  protected:
    ...
    // Purpose:    Get the transform mapping the viewport to the image data.
    // Parameters: None.
    // Returns:    The mapping transform.
    QTransform
