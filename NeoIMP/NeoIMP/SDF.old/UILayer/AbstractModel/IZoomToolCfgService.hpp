#ifndef SDF_UILAYER_ABSTRACTMODEL_IZOOMTOOLSERVICE_HPP
#define SDF_UILAYER_ABSTRACTMODEL_IZOOMTOOLSERVICE_HPP
...
#include <SDF/UILayer/AbstractModel/Properties/Tool/ZoomMode.hpp>
...
namespace SDF::UILayer::AbstractModel {
  ...
  public:
    ...
    // Returns:    None.
    virtual void
    setMode(Properties::Tool::ZoomMode mode) = 0;
    ...
    virtual Properties::Tool::ZoomMode
    getMode() const = 0;
